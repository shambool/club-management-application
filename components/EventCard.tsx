  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.actions}>
        <TouchableOpacity><Ionicons name="checkmark-circle-outline" size={22} /></TouchableOpacity>
        <TouchableOpacity><Ionicons name="chatbubble-ellipses-outline" size={22} /></TouchableOpacity>
        {event.hasVolunteerOption && (
          <TouchableOpacity><Ionicons name="hand-left-outline" size={22} /></TouchableOpacity>
        )}
      </View>
